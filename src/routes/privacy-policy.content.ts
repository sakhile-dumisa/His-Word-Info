...
const privacyPolicyContent = {
	...
	content: {
		...
		item7Title: t({
			...
			zu: "7. Izinguquko Kule Nqubomgomo",
		}),
		item7Content: t({
		...
		item8Title: t({
			...
			zu: "8. Unjiniyela Nemininingwane Yokuxhumana",
		}),
		item8Content1: t({
			en: "His Word is developed and maintained by ",
			zu: "I-His Word idalwe futhi inakekelwa ngu-",
		}),
		item8Content2: t({
